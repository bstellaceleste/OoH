...
const char *const BlockdevQcow2EncryptionFormat_lookup[] = {
    [BLOCKDEV_QCOW2_ENCRYPTION_FORMAT_AES] = "aes",
    [BLOCKDEV_QCOW2_ENCRYPTION_FORMAT_LUKS] = "luks",
    [BLOCKDEV_QCOW2_ENCRYPTION_FORMAT__MAX] = NULL,
};
...
const char *const BlockdevQcowEncryptionFormat_lookup[] = {
    [BLOCKDEV_QCOW_ENCRYPTION_FORMAT_AES] = "aes",
    [BLOCKDEV_QCOW_ENCRYPTION_FORMAT__MAX] = NULL,
};
...
const char *const SocketAddressLegacyKind_lookup[] = {
    ...
    [SOCKET_ADDRESS_LEGACY_KIND__MAX] = NULL,
};
