...
static inline void _nocheck__trace_arm_gt_recalc(int timer, int irqstate, uint64_t nexttick)
{
    if (trace_event_get_state(TRACE_ARM_GT_RECALC)) {
        ...
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_recalc " "gt recalc: timer %d irqstate %d next tick 0x%" PRIx64 "\n",
                      getpid(),
...
static inline void _nocheck__trace_arm_gt_recalc_disabled(int timer)
{
    if (trace_event_get_state(TRACE_ARM_GT_RECALC_DISABLED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_recalc_disabled " "gt recalc: timer %d irqstate 0 timer disabled" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , timer);
    }
...
static inline void _nocheck__trace_arm_gt_cval_write(int timer, uint64_t value)
{
    if (trace_event_get_state(TRACE_ARM_GT_CVAL_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_cval_write " "gt_cval_write: timer %d value 0x%" PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , timer, value);
    }
...
static inline void _nocheck__trace_arm_gt_tval_write(int timer, uint64_t value)
{
    if (trace_event_get_state(TRACE_ARM_GT_TVAL_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_tval_write " "gt_tval_write: timer %d value 0x%" PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , timer, value);
    }
...
static inline void _nocheck__trace_arm_gt_ctl_write(int timer, uint64_t value)
{
    if (trace_event_get_state(TRACE_ARM_GT_CTL_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_ctl_write " "gt_ctl_write: timer %d value 0x%" PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , timer, value);
    }
...
static inline void _nocheck__trace_arm_gt_imask_toggle(int timer, int irqstate)
{
    if (trace_event_get_state(TRACE_ARM_GT_IMASK_TOGGLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_imask_toggle " "gt_ctl_write: timer %d IMASK toggle, new irqstate %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , timer, irqstate);
    }
...
static inline void _nocheck__trace_arm_gt_cntvoff_write(uint64_t value)
{
    if (trace_event_get_state(TRACE_ARM_GT_CNTVOFF_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:arm_gt_cntvoff_write " "gt_cntvoff_write: value 0x%" PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , value);
    }
