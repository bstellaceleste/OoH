...
static inline void _nocheck__trace_usb_packet_state_change(int bus, const char * port, int ep, void * p, const char * o, const char * n)
{
    if (trace_event_get_state(TRACE_USB_PACKET_STATE_CHANGE)) {
        ...
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_packet_state_change " "bus %d, port %s, ep %d, packet %p, state %s -> %s" "\n",
                      getpid(),
...
static inline void _nocheck__trace_usb_packet_state_fault(int bus, const char * port, int ep, void * p, const char * o, const char * n)
{
    if (trace_event_get_state(TRACE_USB_PACKET_STATE_FAULT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_packet_state_fault " "bus %d, port %s, ep %d, packet %p, state %s, expected %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, port, ep, p, o, n);
    }
...
static inline void _nocheck__trace_usb_port_claim(int bus, const char * port)
{
    if (trace_event_get_state(TRACE_USB_PORT_CLAIM)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_port_claim " "bus %d, port %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, port);
    }
...
static inline void _nocheck__trace_usb_port_attach(int bus, const char * port, const char * devspeed, const char * portspeed)
{
    if (trace_event_get_state(TRACE_USB_PORT_ATTACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_port_attach " "bus %d, port %s, devspeed %s, portspeed %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_port_detach(int bus, const char * port)
{
    if (trace_event_get_state(TRACE_USB_PORT_DETACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_port_detach " "bus %d, port %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, port);
    }
...
static inline void _nocheck__trace_usb_port_release(int bus, const char * port)
{
    if (trace_event_get_state(TRACE_USB_PORT_RELEASE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_port_release " "bus %d, port %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, port);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_read_failed(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_READ_FAILED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_read_failed " "ISO_TD read error at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_head(uint32_t head, uint32_t tail, uint32_t flags, uint32_t bp, uint32_t next, uint32_t be, uint32_t framenum, uint32_t startframe, uint32_t framecount, int rel_frame_num)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_HEAD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_head " "ISO_TD ED head 0x%.8x tailp 0x%.8x\n0x%.8x 0x%.8x 0x%.8x 0x%.8x\nframe_number 0x%.8x starting_frame 0x%.8x\nframe_count  0x%.8x relative %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ohci_iso_td_head_offset(uint32_t o0, uint32_t o1, uint32_t o2, uint32_t o3, uint32_t o4, uint32_t o5, uint32_t o6, uint32_t o7)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_HEAD_OFFSET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_head_offset " "0x%.8x 0x%.8x 0x%.8x 0x%.8x 0x%.8x 0x%.8x 0x%.8x 0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ohci_iso_td_bad_direction(int dir)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_BAD_DIRECTION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_bad_direction " "Bad direction %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dir);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_bad_bp_be(uint32_t bp, uint32_t be)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_BAD_BP_BE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_bad_bp_be " "ISO_TD bp 0x%.8x be 0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bp, be);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_bad_cc_not_accessed(uint32_t start, uint32_t next)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_BAD_CC_NOT_ACCESSED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_bad_cc_not_accessed " "ISO_TD cc != not accessed 0x%.8x 0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, next);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_bad_cc_overrun(uint32_t start, uint32_t next)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_BAD_CC_OVERRUN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_bad_cc_overrun " "ISO_TD start_offset=0x%.8x > next_offset=0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , start, next);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_so(uint32_t so, uint32_t eo, uint32_t s, uint32_t e, const char * str, ssize_t len, int ret)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_SO)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_so " "0x%.8x eo 0x%.8x\nsa 0x%.8x ea 0x%.8x\ndir %s len %zu ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ohci_iso_td_data_overrun(int ret, ssize_t len)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_DATA_OVERRUN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_data_overrun " "DataOverrun %d > %zu" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ret, len);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_data_underrun(int ret)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_DATA_UNDERRUN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_data_underrun " "DataUnderrun %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ret);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_nak(int ret)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_NAK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_nak " "got NAK/STALL %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ret);
    }
...
static inline void _nocheck__trace_usb_ohci_iso_td_bad_response(int ret)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ISO_TD_BAD_RESPONSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_iso_td_bad_response " "Bad device response %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , ret);
    }
...
static inline void _nocheck__trace_usb_ohci_port_attach(int index)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PORT_ATTACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_port_attach " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , index);
    }
...
static inline void _nocheck__trace_usb_ohci_port_detach(int index)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PORT_DETACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_port_detach " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , index);
    }
...
static inline void _nocheck__trace_usb_ohci_port_wakeup(int index)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PORT_WAKEUP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_port_wakeup " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , index);
    }
...
static inline void _nocheck__trace_usb_ohci_port_suspend(int index)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PORT_SUSPEND)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_port_suspend " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , index);
    }
...
static inline void _nocheck__trace_usb_ohci_port_reset(int index)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PORT_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_port_reset " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , index);
    }
...
static inline void _nocheck__trace_usb_ohci_remote_wakeup(const char * s)
{
    if (trace_event_get_state(TRACE_USB_OHCI_REMOTE_WAKEUP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_remote_wakeup " "%s: SUSPEND->RESUME" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , s);
    }
...
static inline void _nocheck__trace_usb_ohci_start(const char * s)
{
    if (trace_event_get_state(TRACE_USB_OHCI_START)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_start " "%s: USB Operational" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , s);
    }
...
static inline void _nocheck__trace_usb_ohci_resume(const char * s)
{
    if (trace_event_get_state(TRACE_USB_OHCI_RESUME)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_resume " "%s: USB Resume" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , s);
    }
...
static inline void _nocheck__trace_usb_ohci_stop(const char * s)
{
    if (trace_event_get_state(TRACE_USB_OHCI_STOP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_stop " "%s: USB Suspended" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , s);
    }
...
static inline void _nocheck__trace_usb_ohci_set_ctl(const char * s, uint32_t new_state)
{
    if (trace_event_get_state(TRACE_USB_OHCI_SET_CTL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_set_ctl " "%s: new state 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , s, new_state);
    }
...
static inline void _nocheck__trace_usb_ohci_td_underrun(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_UNDERRUN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_underrun " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_td_dev_error(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_DEV_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_dev_error " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_td_bad_device_response(int rc)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_BAD_DEVICE_RESPONSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_bad_device_response " "%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , rc);
    }
...
static inline void _nocheck__trace_usb_ohci_td_read_error(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_READ_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_read_error " "TD read error at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_td_bad_direction(int dir)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_BAD_DIRECTION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_bad_direction " "Bad direction %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dir);
    }
...
static inline void _nocheck__trace_usb_ohci_td_skip_async(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_SKIP_ASYNC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_skip_async " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_td_pkt_hdr(uint32_t addr, int64_t pktlen, int64_t len, const char * s, int flag_r, uint32_t cbp, uint32_t be)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_PKT_HDR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_pkt_hdr " " TD @ 0x%.8x %" PRId64 " of %" PRId64 " bytes %s r=%d cbp=0x%.8x be=0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ohci_td_pkt_short(const char * dir, const char * buf)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_PKT_SHORT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_pkt_short " "%s data: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dir, buf);
    }
...
static inline void _nocheck__trace_usb_ohci_td_pkt_full(const char * dir, const char * buf)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_PKT_FULL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_pkt_full " "%s data: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dir, buf);
    }
...
static inline void _nocheck__trace_usb_ohci_td_too_many_pending(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_TOO_MANY_PENDING)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_too_many_pending " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_td_packet_status(int status)
{
    if (trace_event_get_state(TRACE_USB_OHCI_TD_PACKET_STATUS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_td_packet_status " "status=%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , status);
    }
...
static inline void _nocheck__trace_usb_ohci_ed_read_error(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ED_READ_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_ed_read_error " "ED read error at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_ed_pkt(uint32_t cur, int h, int c, uint32_t head, uint32_t tail, uint32_t next)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ED_PKT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_ed_pkt " "ED @ 0x%.8x h=%u c=%u\n  head=0x%.8x tailp=0x%.8x next=0x%.8x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ohci_ed_pkt_flags(uint32_t fa, uint32_t en, uint32_t d, int s, int k, int f, uint32_t mps)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ED_PKT_FLAGS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_ed_pkt_flags " "fa=%u en=%u d=%u s=%u k=%u f=%u mps=%u" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , fa, en, d, s, k, f, mps);
    }
...
static inline void _nocheck__trace_usb_ohci_hcca_read_error(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_HCCA_READ_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_hcca_read_error " "HCCA read error at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_mem_read_unaligned(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_MEM_READ_UNALIGNED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_mem_read_unaligned " "at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_mem_read_bad_offset(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_MEM_READ_BAD_OFFSET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_mem_read_bad_offset " "0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_mem_write_unaligned(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_MEM_WRITE_UNALIGNED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_mem_write_unaligned " "at 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_mem_write_bad_offset(uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_OHCI_MEM_WRITE_BAD_OFFSET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_mem_write_bad_offset " "0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr);
    }
...
static inline void _nocheck__trace_usb_ohci_process_lists(uint32_t head, uint32_t cur)
{
    if (trace_event_get_state(TRACE_USB_OHCI_PROCESS_LISTS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_process_lists " "head 0x%x, cur 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , head, cur);
    }
...
static inline void _nocheck__trace_usb_ohci_set_frame_interval(const char * name, uint16_t fi_x, uint16_t fi_u)
{
    if (trace_event_get_state(TRACE_USB_OHCI_SET_FRAME_INTERVAL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_set_frame_interval " "%s: FrameInterval = 0x%x (%u)" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , name, fi_x, fi_u);
    }
...
static inline void _nocheck__trace_usb_ohci_hub_power_up(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_HUB_POWER_UP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_hub_power_up " "powered up all ports" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_hub_power_down(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_HUB_POWER_DOWN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_hub_power_down " "powered down all ports" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ohci_init_time(int64_t frametime, int64_t bittime)
{
    if (trace_event_get_state(TRACE_USB_OHCI_INIT_TIME)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_init_time " "usb_bit_time=%" PRId64 " usb_frame_time=%" PRId64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , frametime, bittime);
    }
...
static inline void _nocheck__trace_usb_ohci_async_complete(void)
{
    if (trace_event_get_state(TRACE_USB_OHCI_ASYNC_COMPLETE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ohci_async_complete " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ehci_reset(void)
{
    if (trace_event_get_state(TRACE_USB_EHCI_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_reset " "=== RESET ===" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ehci_unrealize(void)
{
    if (trace_event_get_state(TRACE_USB_EHCI_UNREALIZE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_unrealize " "=== UNREALIZE ===" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ehci_opreg_read(uint32_t addr, const char * str, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_EHCI_OPREG_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_opreg_read " "rd mmio 0x%04x [%s] = 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, str, val);
    }
...
static inline void _nocheck__trace_usb_ehci_opreg_write(uint32_t addr, const char * str, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_EHCI_OPREG_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_opreg_write " "wr mmio 0x%04x [%s] = 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, str, val);
    }
...
static inline void _nocheck__trace_usb_ehci_opreg_change(uint32_t addr, const char * str, uint32_t new, uint32_t old)
{
    if (trace_event_get_state(TRACE_USB_EHCI_OPREG_CHANGE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_opreg_change " "ch mmio 0x%04x [%s] = 0x%x (old: 0x%x)" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, str, new, old);
    }
...
static inline void _nocheck__trace_usb_ehci_portsc_read(uint32_t addr, uint32_t port, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORTSC_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_portsc_read " "rd mmio 0x%04x [port %d] = 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, port, val);
    }
...
static inline void _nocheck__trace_usb_ehci_portsc_write(uint32_t addr, uint32_t port, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORTSC_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_portsc_write " "wr mmio 0x%04x [port %d] = 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, port, val);
    }
...
static inline void _nocheck__trace_usb_ehci_portsc_change(uint32_t addr, uint32_t port, uint32_t new, uint32_t old)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORTSC_CHANGE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_portsc_change " "ch mmio 0x%04x [port %d] = 0x%x (old: 0x%x)" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, port, new, old);
    }
...
static inline void _nocheck__trace_usb_ehci_usbsts(const char * sts, int state)
{
    if (trace_event_get_state(TRACE_USB_EHCI_USBSTS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_usbsts " "usbsts %s %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , sts, state);
    }
...
static inline void _nocheck__trace_usb_ehci_state(const char * schedule, const char * state)
{
    if (trace_event_get_state(TRACE_USB_EHCI_STATE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_state " "%s schedule %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , schedule, state);
    }
...
static inline void _nocheck__trace_usb_ehci_qh_ptrs(void * q, uint32_t addr, uint32_t nxt, uint32_t c_qtd, uint32_t n_qtd, uint32_t a_qtd)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QH_PTRS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qh_ptrs " "q %p - QH @ 0x%08x: next 0x%08x qtds 0x%08x,0x%08x,0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_qh_fields(uint32_t addr, int rl, int mplen, int eps, int ep, int devaddr)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QH_FIELDS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qh_fields " "QH @ 0x%08x - rl %d, mplen %d, eps %d, ep %d, dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_qh_bits(uint32_t addr, int c, int h, int dtc, int i)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QH_BITS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qh_bits " "QH @ 0x%08x - c %d, h %d, dtc %d, i %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, c, h, dtc, i);
    }
...
static inline void _nocheck__trace_usb_ehci_qtd_ptrs(void * q, uint32_t addr, uint32_t nxt, uint32_t altnext)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QTD_PTRS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qtd_ptrs " "q %p - QTD @ 0x%08x: next 0x%08x altnext 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , q, addr, nxt, altnext);
    }
...
static inline void _nocheck__trace_usb_ehci_qtd_fields(uint32_t addr, int tbytes, int cpage, int cerr, int pid)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QTD_FIELDS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qtd_fields " "QTD @ 0x%08x - tbytes %d, cpage %d, cerr %d, pid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_qtd_bits(uint32_t addr, int ioc, int active, int halt, int babble, int xacterr)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QTD_BITS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_qtd_bits " "QTD @ 0x%08x - ioc %d, active %d, halt %d, babble %d, xacterr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_itd(uint32_t addr, uint32_t nxt, uint32_t mplen, uint32_t mult, uint32_t ep, uint32_t devaddr)
{
    if (trace_event_get_state(TRACE_USB_EHCI_ITD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_itd " "ITD @ 0x%08x: next 0x%08x - mplen %d, mult %d, ep %d, dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_sitd(uint32_t addr, uint32_t nxt, uint32_t active)
{
    if (trace_event_get_state(TRACE_USB_EHCI_SITD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_sitd " "ITD @ 0x%08x: next 0x%08x - active %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, nxt, active);
    }
...
static inline void _nocheck__trace_usb_ehci_port_attach(uint32_t port, const char * owner, const char * device)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_ATTACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_attach " "attach port #%d, owner %s, device %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, owner, device);
    }
...
static inline void _nocheck__trace_usb_ehci_port_detach(uint32_t port, const char * owner)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_DETACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_detach " "detach port #%d, owner %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, owner);
    }
...
static inline void _nocheck__trace_usb_ehci_port_reset(uint32_t port, int enable)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_reset " "reset port #%d - %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, enable);
    }
...
static inline void _nocheck__trace_usb_ehci_port_suspend(uint32_t port)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_SUSPEND)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_suspend " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port);
    }
...
static inline void _nocheck__trace_usb_ehci_port_wakeup(uint32_t port)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_WAKEUP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_wakeup " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port);
    }
...
static inline void _nocheck__trace_usb_ehci_port_resume(uint32_t port)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PORT_RESUME)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_port_resume " "port #%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port);
    }
...
static inline void _nocheck__trace_usb_ehci_queue_action(void * q, const char * action)
{
    if (trace_event_get_state(TRACE_USB_EHCI_QUEUE_ACTION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_queue_action " "q %p: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , q, action);
    }
...
static inline void _nocheck__trace_usb_ehci_packet_action(void * q, void * p, const char * action)
{
    if (trace_event_get_state(TRACE_USB_EHCI_PACKET_ACTION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_packet_action " "q %p p %p: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , q, p, action);
    }
...
static inline void _nocheck__trace_usb_ehci_irq(uint32_t level, uint32_t frindex, uint32_t sts, uint32_t mask)
{
    if (trace_event_get_state(TRACE_USB_EHCI_IRQ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_irq " "level %d, frindex 0x%04x, sts 0x%x, mask 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_ehci_guest_bug(const char * reason)
{
    if (trace_event_get_state(TRACE_USB_EHCI_GUEST_BUG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_guest_bug " "%s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , reason);
    }
...
static inline void _nocheck__trace_usb_ehci_doorbell_ring(void)
{
    if (trace_event_get_state(TRACE_USB_EHCI_DOORBELL_RING)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_doorbell_ring " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_ehci_doorbell_ack(void)
{
    if (trace_event_get_state(TRACE_USB_EHCI_DOORBELL_ACK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_ehci_doorbell_ack " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_reset(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_reset " "=== RESET ===" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_schedule_start(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_SCHEDULE_START)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_schedule_start " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_schedule_stop(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_SCHEDULE_STOP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_schedule_stop " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_frame_start(uint32_t num)
{
    if (trace_event_get_state(TRACE_USB_UHCI_FRAME_START)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_frame_start " "nr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , num);
    }
...
static inline void _nocheck__trace_usb_uhci_frame_stop_bandwidth(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_FRAME_STOP_BANDWIDTH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_frame_stop_bandwidth " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_frame_loop_stop_idle(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_FRAME_LOOP_STOP_IDLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_frame_loop_stop_idle " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_frame_loop_continue(void)
{
    if (trace_event_get_state(TRACE_USB_UHCI_FRAME_LOOP_CONTINUE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_frame_loop_continue " "" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_uhci_mmio_readw(uint32_t addr, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_UHCI_MMIO_READW)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_mmio_readw " "addr 0x%04x, ret 0x%04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, val);
    }
...
static inline void _nocheck__trace_usb_uhci_mmio_writew(uint32_t addr, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_UHCI_MMIO_WRITEW)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_mmio_writew " "addr 0x%04x, val 0x%04x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, val);
    }
...
static inline void _nocheck__trace_usb_uhci_queue_add(uint32_t token)
{
    if (trace_event_get_state(TRACE_USB_UHCI_QUEUE_ADD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_queue_add " "token 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token);
    }
...
static inline void _nocheck__trace_usb_uhci_queue_del(uint32_t token, const char * reason)
{
    if (trace_event_get_state(TRACE_USB_UHCI_QUEUE_DEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_queue_del " "token 0x%x: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, reason);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_add(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_ADD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_add " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_link_async(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_LINK_ASYNC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_link_async " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_unlink_async(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_UNLINK_ASYNC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_unlink_async " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_cancel(uint32_t token, uint32_t addr, int done)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_CANCEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_cancel " "token 0x%x, td 0x%x, done %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr, done);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_complete_stall(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_COMPLETE_STALL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_complete_stall " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_complete_babble(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_COMPLETE_BABBLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_complete_babble " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_complete_error(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_COMPLETE_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_complete_error " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_packet_del(uint32_t token, uint32_t addr)
{
    if (trace_event_get_state(TRACE_USB_UHCI_PACKET_DEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_packet_del " "token 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , token, addr);
    }
...
static inline void _nocheck__trace_usb_uhci_qh_load(uint32_t qh)
{
    if (trace_event_get_state(TRACE_USB_UHCI_QH_LOAD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_qh_load " "qh 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , qh);
    }
...
static inline void _nocheck__trace_usb_uhci_td_load(uint32_t qh, uint32_t td, uint32_t ctrl, uint32_t token)
{
    if (trace_event_get_state(TRACE_USB_UHCI_TD_LOAD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_td_load " "qh 0x%x, td 0x%x, ctrl 0x%x, token 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , qh, td, ctrl, token);
    }
...
static inline void _nocheck__trace_usb_uhci_td_queue(uint32_t td, uint32_t ctrl, uint32_t token)
{
    if (trace_event_get_state(TRACE_USB_UHCI_TD_QUEUE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_td_queue " "td 0x%x, ctrl 0x%x, token 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , td, ctrl, token);
    }
...
static inline void _nocheck__trace_usb_uhci_td_nextqh(uint32_t qh, uint32_t td)
{
    if (trace_event_get_state(TRACE_USB_UHCI_TD_NEXTQH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_td_nextqh " "qh 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , qh, td);
    }
...
static inline void _nocheck__trace_usb_uhci_td_async(uint32_t qh, uint32_t td)
{
    if (trace_event_get_state(TRACE_USB_UHCI_TD_ASYNC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_td_async " "qh 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , qh, td);
    }
...
static inline void _nocheck__trace_usb_uhci_td_complete(uint32_t qh, uint32_t td)
{
    if (trace_event_get_state(TRACE_USB_UHCI_TD_COMPLETE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uhci_td_complete " "qh 0x%x, td 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , qh, td);
    }
...
static inline void _nocheck__trace_usb_xhci_reset(void)
{
    if (trace_event_get_state(TRACE_USB_XHCI_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_reset " "=== RESET ===" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_xhci_cap_read(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_CAP_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_cap_read " "off 0x%04x, ret 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_oper_read(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_OPER_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_oper_read " "off 0x%04x, ret 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_port_read(uint32_t port, uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_PORT_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_port_read " "port %d, off 0x%04x, ret 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_runtime_read(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_RUNTIME_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_runtime_read " "off 0x%04x, ret 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_doorbell_read(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_DOORBELL_READ)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_doorbell_read " "off 0x%04x, ret 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_oper_write(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_OPER_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_oper_write " "off 0x%04x, val 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_port_write(uint32_t port, uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_PORT_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_port_write " "port %d, off 0x%04x, val 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_runtime_write(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_RUNTIME_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_runtime_write " "off 0x%04x, val 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_doorbell_write(uint32_t off, uint32_t val)
{
    if (trace_event_get_state(TRACE_USB_XHCI_DOORBELL_WRITE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_doorbell_write " "off 0x%04x, val 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , off, val);
    }
...
static inline void _nocheck__trace_usb_xhci_irq_intx(uint32_t level)
{
    if (trace_event_get_state(TRACE_USB_XHCI_IRQ_INTX)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_irq_intx " "level %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , level);
    }
...
static inline void _nocheck__trace_usb_xhci_irq_msi(uint32_t nr)
{
    if (trace_event_get_state(TRACE_USB_XHCI_IRQ_MSI)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_irq_msi " "nr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , nr);
    }
...
static inline void _nocheck__trace_usb_xhci_irq_msix(uint32_t nr)
{
    if (trace_event_get_state(TRACE_USB_XHCI_IRQ_MSIX)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_irq_msix " "nr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , nr);
    }
...
static inline void _nocheck__trace_usb_xhci_irq_msix_use(uint32_t nr)
{
    if (trace_event_get_state(TRACE_USB_XHCI_IRQ_MSIX_USE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_irq_msix_use " "nr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , nr);
    }
...
static inline void _nocheck__trace_usb_xhci_irq_msix_unuse(uint32_t nr)
{
    if (trace_event_get_state(TRACE_USB_XHCI_IRQ_MSIX_UNUSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_irq_msix_unuse " "nr %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , nr);
    }
...
static inline void _nocheck__trace_usb_xhci_queue_event(uint32_t vector, uint32_t idx, const char * trb, const char * evt, uint64_t param, uint32_t status, uint32_t control)
{
    if (trace_event_get_state(TRACE_USB_XHCI_QUEUE_EVENT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_queue_event " "v %d, idx %d, %s, %s, p 0x%016" PRIx64 ", s 0x%08x, c 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_xhci_fetch_trb(uint64_t addr, const char * name, uint64_t param, uint32_t status, uint32_t control)
{
    if (trace_event_get_state(TRACE_USB_XHCI_FETCH_TRB)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_fetch_trb " "addr 0x%016" PRIx64 ", %s, p 0x%016" PRIx64 ", s 0x%08x, c 0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_xhci_port_reset(uint32_t port, bool warm)
{
    if (trace_event_get_state(TRACE_USB_XHCI_PORT_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_port_reset " "port %d, warm %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, warm);
    }
...
static inline void _nocheck__trace_usb_xhci_port_link(uint32_t port, uint32_t pls)
{
    if (trace_event_get_state(TRACE_USB_XHCI_PORT_LINK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_port_link " "port %d, pls %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, pls);
    }
...
static inline void _nocheck__trace_usb_xhci_port_notify(uint32_t port, uint32_t pls)
{
    if (trace_event_get_state(TRACE_USB_XHCI_PORT_NOTIFY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_port_notify " "port %d, bits 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , port, pls);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_enable(uint32_t slotid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_ENABLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_enable " "slotid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_disable(uint32_t slotid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_DISABLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_disable " "slotid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_address(uint32_t slotid, const char * port)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_ADDRESS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_address " "slotid %d, port %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, port);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_configure(uint32_t slotid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_CONFIGURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_configure " "slotid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_evaluate(uint32_t slotid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_EVALUATE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_evaluate " "slotid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid);
    }
...
static inline void _nocheck__trace_usb_xhci_slot_reset(uint32_t slotid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_SLOT_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_slot_reset " "slotid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid);
    }
...
static inline void _nocheck__trace_usb_xhci_ep_enable(uint32_t slotid, uint32_t epid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_ENABLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_enable " "slotid %d, epid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, epid);
    }
...
static inline void _nocheck__trace_usb_xhci_ep_disable(uint32_t slotid, uint32_t epid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_DISABLE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_disable " "slotid %d, epid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, epid);
    }
...
static inline void _nocheck__trace_usb_xhci_ep_set_dequeue(uint32_t slotid, uint32_t epid, uint32_t streamid, uint64_t param)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_SET_DEQUEUE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_set_dequeue " "slotid %d, epid %d, streamid %d, ptr 0x%016" PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_xhci_ep_kick(uint32_t slotid, uint32_t epid, uint32_t streamid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_KICK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_kick " "slotid %d, epid %d, streamid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_xhci_ep_stop(uint32_t slotid, uint32_t epid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_STOP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_stop " "slotid %d, epid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, epid);
    }
...
static inline void _nocheck__trace_usb_xhci_ep_reset(uint32_t slotid, uint32_t epid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_reset " "slotid %d, epid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, epid);
    }
...
static inline void _nocheck__trace_usb_xhci_ep_state(uint32_t slotid, uint32_t epid, const char * os, const char * ns)
{
    if (trace_event_get_state(TRACE_USB_XHCI_EP_STATE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_ep_state " "slotid %d, epid %d, %s -> %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , slotid, epid, os, ns);
    }
...
static inline void _nocheck__trace_usb_xhci_xfer_start(void * xfer, uint32_t slotid, uint32_t epid, uint32_t streamid)
{
    if (trace_event_get_state(TRACE_USB_XHCI_XFER_START)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_xfer_start " "%p: slotid %d, epid %d, streamid %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_xhci_xfer_async(void * xfer)
{
    if (trace_event_get_state(TRACE_USB_XHCI_XFER_ASYNC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_xfer_async " "%p" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , xfer);
    }
...
static inline void _nocheck__trace_usb_xhci_xfer_retry(void * xfer)
{
    if (trace_event_get_state(TRACE_USB_XHCI_XFER_RETRY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_xfer_retry " "%p" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , xfer);
    }
...
static inline void _nocheck__trace_usb_xhci_xfer_success(void * xfer, uint32_t bytes)
{
    if (trace_event_get_state(TRACE_USB_XHCI_XFER_SUCCESS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_xfer_success " "%p: len %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , xfer, bytes);
    }
...
static inline void _nocheck__trace_usb_xhci_xfer_error(void * xfer, uint32_t ret)
{
    if (trace_event_get_state(TRACE_USB_XHCI_XFER_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_xfer_error " "%p: ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , xfer, ret);
    }
...
static inline void _nocheck__trace_usb_xhci_unimplemented(const char * item, int nr)
{
    if (trace_event_get_state(TRACE_USB_XHCI_UNIMPLEMENTED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_unimplemented " "%s (0x%x)" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , item, nr);
    }
...
static inline void _nocheck__trace_usb_xhci_enforced_limit(const char * item)
{
    if (trace_event_get_state(TRACE_USB_XHCI_ENFORCED_LIMIT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_xhci_enforced_limit " "%s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , item);
    }
...
static inline void _nocheck__trace_usb_desc_device(int addr, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_DEVICE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_device " "dev %d query device, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_device_qualifier(int addr, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_DEVICE_QUALIFIER)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_device_qualifier " "dev %d query device qualifier, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_config(int addr, int index, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_config " "dev %d query config %d, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, index, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_other_speed_config(int addr, int index, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_OTHER_SPEED_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_other_speed_config " "dev %d query config %d, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, index, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_string(int addr, int index, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_STRING)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_string " "dev %d query string %d, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, index, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_bos(int addr, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_BOS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_bos " "dev %d bos, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, len, ret);
    }
...
static inline void _nocheck__trace_usb_desc_msos(int addr, int index, int len, int ret)
{
    if (trace_event_get_state(TRACE_USB_DESC_MSOS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_desc_msos " "dev %d msos, index 0x%x, len %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, index, len, ret);
    }
...
static inline void _nocheck__trace_usb_set_config(int addr, int config, int ret)
{
    if (trace_event_get_state(TRACE_USB_SET_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_set_config " "dev %d, config %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, config, ret);
    }
...
static inline void _nocheck__trace_usb_set_interface(int addr, int iface, int alt, int ret)
{
    if (trace_event_get_state(TRACE_USB_SET_INTERFACE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_set_interface " "dev %d, interface %d, altsetting %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, iface, alt, ret);
    }
...
static inline void _nocheck__trace_usb_clear_device_feature(int addr, int feature, int ret)
{
    if (trace_event_get_state(TRACE_USB_CLEAR_DEVICE_FEATURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_clear_device_feature " "dev %d, feature %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, feature, ret);
    }
...
static inline void _nocheck__trace_usb_set_device_feature(int addr, int feature, int ret)
{
    if (trace_event_get_state(TRACE_USB_SET_DEVICE_FEATURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_set_device_feature " "dev %d, feature %d, ret %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, feature, ret);
    }
...
static inline void _nocheck__trace_usb_hub_control(int addr, int request, int value, int index, int length)
{
    if (trace_event_get_state(TRACE_USB_HUB_CONTROL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_control " "dev %d, req 0x%x, value %d, index %d, langth %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_hub_get_port_status(int addr, int nr, int status, int changed)
{
    if (trace_event_get_state(TRACE_USB_HUB_GET_PORT_STATUS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_get_port_status " "dev %d, port %d, status 0x%x, changed 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_hub_set_port_feature(int addr, int nr, const char * f)
{
    if (trace_event_get_state(TRACE_USB_HUB_SET_PORT_FEATURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_set_port_feature " "dev %d, port %d, feature %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, nr, f);
    }
...
static inline void _nocheck__trace_usb_hub_clear_port_feature(int addr, int nr, const char * f)
{
    if (trace_event_get_state(TRACE_USB_HUB_CLEAR_PORT_FEATURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_clear_port_feature " "dev %d, port %d, feature %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, nr, f);
    }
...
static inline void _nocheck__trace_usb_hub_attach(int addr, int nr)
{
    if (trace_event_get_state(TRACE_USB_HUB_ATTACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_attach " "dev %d, port %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, nr);
    }
...
static inline void _nocheck__trace_usb_hub_detach(int addr, int nr)
{
    if (trace_event_get_state(TRACE_USB_HUB_DETACH)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_detach " "dev %d, port %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, nr);
    }
...
static inline void _nocheck__trace_usb_hub_status_report(int addr, int status)
{
    if (trace_event_get_state(TRACE_USB_HUB_STATUS_REPORT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_hub_status_report " "dev %d, status 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, status);
    }
...
static inline void _nocheck__trace_usb_uas_command(int addr, uint16_t tag, int lun, uint32_t lun64_1, uint32_t lun64_2)
{
    if (trace_event_get_state(TRACE_USB_UAS_COMMAND)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_command " "dev %d, tag 0x%x, lun %d, lun64 0x%08x-0x%08x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_uas_response(int addr, uint16_t tag, uint8_t code)
{
    if (trace_event_get_state(TRACE_USB_UAS_RESPONSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_response " "dev %d, tag 0x%x, code 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, code);
    }
...
static inline void _nocheck__trace_usb_uas_sense(int addr, uint16_t tag, uint8_t status)
{
    if (trace_event_get_state(TRACE_USB_UAS_SENSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_sense " "dev %d, tag 0x%x, status 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, status);
    }
...
static inline void _nocheck__trace_usb_uas_read_ready(int addr, uint16_t tag)
{
    if (trace_event_get_state(TRACE_USB_UAS_READ_READY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_read_ready " "dev %d, tag 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag);
    }
...
static inline void _nocheck__trace_usb_uas_write_ready(int addr, uint16_t tag)
{
    if (trace_event_get_state(TRACE_USB_UAS_WRITE_READY)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_write_ready " "dev %d, tag 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag);
    }
...
static inline void _nocheck__trace_usb_uas_xfer_data(int addr, uint16_t tag, uint32_t copy, uint32_t uoff, uint32_t usize, uint32_t soff, uint32_t ssize)
{
    if (trace_event_get_state(TRACE_USB_UAS_XFER_DATA)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_xfer_data " "dev %d, tag 0x%x, copy %d, usb-pkt %d/%d, scsi-buf %d/%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_uas_scsi_data(int addr, uint16_t tag, uint32_t bytes)
{
    if (trace_event_get_state(TRACE_USB_UAS_SCSI_DATA)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_scsi_data " "dev %d, tag 0x%x, bytes %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, bytes);
    }
...
static inline void _nocheck__trace_usb_uas_scsi_complete(int addr, uint16_t tag, uint32_t status, uint32_t resid)
{
    if (trace_event_get_state(TRACE_USB_UAS_SCSI_COMPLETE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_scsi_complete " "dev %d, tag 0x%x, status 0x%x, residue %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_uas_tmf_abort_task(int addr, uint16_t tag, uint16_t task_tag)
{
    if (trace_event_get_state(TRACE_USB_UAS_TMF_ABORT_TASK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_tmf_abort_task " "dev %d, tag 0x%x, task-tag 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, task_tag);
    }
...
static inline void _nocheck__trace_usb_uas_tmf_logical_unit_reset(int addr, uint16_t tag, int lun)
{
    if (trace_event_get_state(TRACE_USB_UAS_TMF_LOGICAL_UNIT_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_tmf_logical_unit_reset " "dev %d, tag 0x%x, lun %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, lun);
    }
...
static inline void _nocheck__trace_usb_uas_tmf_unsupported(int addr, uint16_t tag, uint32_t function)
{
    if (trace_event_get_state(TRACE_USB_UAS_TMF_UNSUPPORTED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_uas_tmf_unsupported " "dev %d, tag 0x%x, function 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , addr, tag, function);
    }
...
static inline void _nocheck__trace_usb_mtp_command(int dev, uint16_t code, uint32_t trans, uint32_t arg0, uint32_t arg1, uint32_t arg2, uint32_t arg3, uint32_t arg4)
{
    if (trace_event_get_state(TRACE_USB_MTP_COMMAND)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_command " "dev %d, code 0x%x, trans 0x%x, args 0x%x, 0x%x, 0x%x, 0x%x, 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_mtp_success(int dev, uint32_t trans, uint32_t arg0, uint32_t arg1)
{
    if (trace_event_get_state(TRACE_USB_MTP_SUCCESS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_success " "dev %d, trans 0x%x, args 0x%x, 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, trans, arg0, arg1);
    }
...
static inline void _nocheck__trace_usb_mtp_error(int dev, uint16_t code, uint32_t trans, uint32_t arg0, uint32_t arg1)
{
    if (trace_event_get_state(TRACE_USB_MTP_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_error " "dev %d, code 0x%x, trans 0x%x, args 0x%x, 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_mtp_data_in(int dev, uint32_t trans, uint32_t len)
{
    if (trace_event_get_state(TRACE_USB_MTP_DATA_IN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_data_in " "dev %d, trans 0x%x, len %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, trans, len);
    }
...
static inline void _nocheck__trace_usb_mtp_xfer(int dev, uint32_t ep, uint32_t dlen, uint32_t plen)
{
    if (trace_event_get_state(TRACE_USB_MTP_XFER)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_xfer " "dev %d, ep %d, %d/%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, ep, dlen, plen);
    }
...
static inline void _nocheck__trace_usb_mtp_nak(int dev, uint32_t ep)
{
    if (trace_event_get_state(TRACE_USB_MTP_NAK)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_nak " "dev %d, ep %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, ep);
    }
...
static inline void _nocheck__trace_usb_mtp_stall(int dev, const char * reason)
{
    if (trace_event_get_state(TRACE_USB_MTP_STALL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_stall " "dev %d, reason: %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, reason);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_device_info(int dev)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_DEVICE_INFO)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_device_info " "dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev);
    }
...
static inline void _nocheck__trace_usb_mtp_op_open_session(int dev)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_OPEN_SESSION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_open_session " "dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev);
    }
...
static inline void _nocheck__trace_usb_mtp_op_close_session(int dev)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_CLOSE_SESSION)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_close_session " "dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_storage_ids(int dev)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_STORAGE_IDS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_storage_ids " "dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_storage_info(int dev)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_STORAGE_INFO)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_storage_info " "dev %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_num_objects(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_NUM_OBJECTS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_num_objects " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_object_handles(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_OBJECT_HANDLES)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_object_handles " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_object_info(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_OBJECT_INFO)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_object_info " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_object(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_OBJECT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_object " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_op_get_partial_object(int dev, uint32_t handle, const char * path, uint32_t offset, uint32_t length)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_GET_PARTIAL_OBJECT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_get_partial_object " "dev %d, handle 0x%x, path %s, off %d, len %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_mtp_op_unknown(int dev, uint32_t code)
{
    if (trace_event_get_state(TRACE_USB_MTP_OP_UNKNOWN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_op_unknown " "dev %d, command code 0x%x" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, code);
    }
...
static inline void _nocheck__trace_usb_mtp_object_alloc(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OBJECT_ALLOC)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_object_alloc " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_object_free(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_OBJECT_FREE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_object_free " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
static inline void _nocheck__trace_usb_mtp_add_child(int dev, uint32_t handle, const char * path)
{
    if (trace_event_get_state(TRACE_USB_MTP_ADD_CHILD)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_add_child " "dev %d, handle 0x%x, path %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, handle, path);
    }
...
#define TRACE_USB_MTP_INOTIFY_EVENT_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_USB_MTP_INOTIFY_EVENT) || \
    false)
...
static inline void _nocheck__trace_usb_mtp_inotify_event(int dev, const char * path, uint32_t mask, const char * s)
{
    if (trace_event_get_state(TRACE_USB_MTP_INOTIFY_EVENT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_mtp_inotify_event " "dev %d, path %s mask 0x%x event %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , dev, path, mask, s);
    }
...
static inline void _nocheck__trace_usb_host_open_started(int bus, int addr)
{
    if (trace_event_get_state(TRACE_USB_HOST_OPEN_STARTED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_open_started " "dev %d:%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr);
    }
...
static inline void _nocheck__trace_usb_host_open_success(int bus, int addr)
{
    if (trace_event_get_state(TRACE_USB_HOST_OPEN_SUCCESS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_open_success " "dev %d:%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr);
    }
...
static inline void _nocheck__trace_usb_host_open_failure(int bus, int addr)
{
    if (trace_event_get_state(TRACE_USB_HOST_OPEN_FAILURE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_open_failure " "dev %d:%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr);
    }
...
static inline void _nocheck__trace_usb_host_close(int bus, int addr)
{
    if (trace_event_get_state(TRACE_USB_HOST_CLOSE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_close " "dev %d:%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr);
    }
...
static inline void _nocheck__trace_usb_host_attach_kernel(int bus, int addr, int interface)
{
    if (trace_event_get_state(TRACE_USB_HOST_ATTACH_KERNEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_attach_kernel " "dev %d:%d, if %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, interface);
    }
...
static inline void _nocheck__trace_usb_host_detach_kernel(int bus, int addr, int interface)
{
    if (trace_event_get_state(TRACE_USB_HOST_DETACH_KERNEL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_detach_kernel " "dev %d:%d, if %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, interface);
    }
...
static inline void _nocheck__trace_usb_host_set_address(int bus, int addr, int config)
{
    if (trace_event_get_state(TRACE_USB_HOST_SET_ADDRESS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_set_address " "dev %d:%d, address %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, config);
    }
...
static inline void _nocheck__trace_usb_host_set_config(int bus, int addr, int config)
{
    if (trace_event_get_state(TRACE_USB_HOST_SET_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_set_config " "dev %d:%d, config %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, config);
    }
...
static inline void _nocheck__trace_usb_host_set_interface(int bus, int addr, int interface, int alt)
{
    if (trace_event_get_state(TRACE_USB_HOST_SET_INTERFACE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_set_interface " "dev %d:%d, interface %d, alt %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_claim_interface(int bus, int addr, int config, int interface)
{
    if (trace_event_get_state(TRACE_USB_HOST_CLAIM_INTERFACE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_claim_interface " "dev %d:%d, config %d, if %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_release_interface(int bus, int addr, int interface)
{
    if (trace_event_get_state(TRACE_USB_HOST_RELEASE_INTERFACE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_release_interface " "dev %d:%d, if %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, interface);
    }
...
static inline void _nocheck__trace_usb_host_req_control(int bus, int addr, void * p, int req, int value, int index)
{
    if (trace_event_get_state(TRACE_USB_HOST_REQ_CONTROL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_req_control " "dev %d:%d, packet %p, req 0x%x, value %d, index %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_req_data(int bus, int addr, void * p, int in, int ep, int size)
{
    if (trace_event_get_state(TRACE_USB_HOST_REQ_DATA)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_req_data " "dev %d:%d, packet %p, in %d, ep %d, size %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_req_complete(int bus, int addr, void * p, int status, int length)
{
    if (trace_event_get_state(TRACE_USB_HOST_REQ_COMPLETE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_req_complete " "dev %d:%d, packet %p, status %d, length %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_req_emulated(int bus, int addr, void * p, int status)
{
    if (trace_event_get_state(TRACE_USB_HOST_REQ_EMULATED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_req_emulated " "dev %d:%d, packet %p, status %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, p, status);
    }
...
static inline void _nocheck__trace_usb_host_req_canceled(int bus, int addr, void * p)
{
    if (trace_event_get_state(TRACE_USB_HOST_REQ_CANCELED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_req_canceled " "dev %d:%d, packet %p" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, p);
    }
...
static inline void _nocheck__trace_usb_host_iso_start(int bus, int addr, int ep)
{
    if (trace_event_get_state(TRACE_USB_HOST_ISO_START)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_iso_start " "dev %d:%d, ep %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, ep);
    }
...
static inline void _nocheck__trace_usb_host_iso_stop(int bus, int addr, int ep)
{
    if (trace_event_get_state(TRACE_USB_HOST_ISO_STOP)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_iso_stop " "dev %d:%d, ep %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, ep);
    }
...
static inline void _nocheck__trace_usb_host_iso_out_of_bufs(int bus, int addr, int ep)
{
    if (trace_event_get_state(TRACE_USB_HOST_ISO_OUT_OF_BUFS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_iso_out_of_bufs " "dev %d:%d, ep %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, ep);
    }
...
static inline void _nocheck__trace_usb_host_reset(int bus, int addr)
{
    if (trace_event_get_state(TRACE_USB_HOST_RESET)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_reset " "dev %d:%d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr);
    }
...
static inline void _nocheck__trace_usb_host_auto_scan_enabled(void)
{
    if (trace_event_get_state(TRACE_USB_HOST_AUTO_SCAN_ENABLED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_auto_scan_enabled "  "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_host_auto_scan_disabled(void)
{
    if (trace_event_get_state(TRACE_USB_HOST_AUTO_SCAN_DISABLED)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_auto_scan_disabled "  "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      );
    }
...
static inline void _nocheck__trace_usb_host_parse_config(int bus, int addr, int value, int active)
{
    if (trace_event_get_state(TRACE_USB_HOST_PARSE_CONFIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_parse_config " "dev %d:%d, value %d, active %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_parse_interface(int bus, int addr, int num, int alt, int active)
{
    if (trace_event_get_state(TRACE_USB_HOST_PARSE_INTERFACE)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_parse_interface " "dev %d:%d, num %d, alt %d, active %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_parse_endpoint(int bus, int addr, int ep, const char * dir, const char * type, int active)
{
    if (trace_event_get_state(TRACE_USB_HOST_PARSE_ENDPOINT)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_parse_endpoint " "dev %d:%d, ep %d, %s, %s, active %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_usb_host_parse_error(int bus, int addr, const char * errmsg)
{
    if (trace_event_get_state(TRACE_USB_HOST_PARSE_ERROR)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:usb_host_parse_error " "dev %d:%d, msg %s" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , bus, addr, errmsg);
    }
