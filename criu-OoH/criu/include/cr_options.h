...
double time_Cp, time_Cproc, time_Cpml, time_RevMap, time_impact;
double time_Cproc_pipe_add_page, time_Cpml_pipe_add_page, time_Cproc_get_vma_map, time_Cpml_get_vma_map, time_Cproc_clear_refs;
