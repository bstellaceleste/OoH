/////////////////////////////////////////////////////////////////////////
// $Id: proc_ctrl.cc 13869 2020-05-29 12:35:30Z sshwarts $
/////////////////////////////////////////////////////////////////////////
//
...
{
BX_INFO(("bitchebe CacheLookups : %lu\n" 
         "bitchebe CachePrefetch : %lu\n" 
         "bitchebe CacheMisses : %lu\n" 
         "bitchebe tlbLookups : %lu\n" 
         "bitchebe tlbMisses : %lu\n", ooh_counters[0], ooh_counters[1], ooh_counters[2], ooh_counters[3], ooh_counters[4]));
#if BX_CPU_LEVEL >= 5
  // in real mode CPL=0
  ...
  BX_ERROR(("bitchebe --- RDPMC: Performance Counters Support not implemented yet"));
#endif
