/////////////////////////////////////////////////////////////////////////
// $Id: vmx.h 13871 2020-05-29 12:55:56Z sshwarts $
/////////////////////////////////////////////////////////////////////////
//
 ...
 */
//#define VMCS_16BIT_GUEST_PML_LINDEX                        0x00000814 /* Virtual Page Modification Logging */
 ...
 * vtf bitchebe -- Must provide comment later
 */
#define VMCS_64BIT_GUEST_PML_ADDRESS                      0x0000281A /* Linear Page Modification Logging -- for the guest p*/
#define VMCS_64BIT_GUEST_PML_ADDRESS_HI                   0x0000281B
#define VMCS_64BIT_GUEST_PML_CR3                          0x0000281C /* value of cr3_pa() for the tracked process in the guest */
#define VMCS_64BIT_GUEST_PML_CR3_HI                       0x0000281D 
//
...
#define VMX_HIGHEST_VMCS_ENCODING   (0x36) //vtf bitchebe -- Must provide comment later : as we added 2fields in vmcs we extend the highest encoding from 0x34 to 0x36
// ===============================
