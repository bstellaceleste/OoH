...
#define BX_HAVE_MVHLINE 1
#define BX_HAVE_MVVLINE 1
...
#define BX_NETMOD_LINUX 1
#define BX_NETMOD_WIN32   0
#define BX_NETMOD_TAP     0
#define BX_NETMOD_TUNTAP 1
#define BX_NETMOD_VDE 1
...
#define BX_SOUND_LOWLEVEL_NAME "oss"
// resampling support
