...
#define P2M_BASE_EADDR     (~0ULL)
    ...
    int                 (*update_ept_spp_range_wp)(struct p2m_domain *p2m,
                                 unsigned long gfn, int range);
    int                (*spp_set_entry)(struct p2m_domain *p2m,
                                unsigned long gfn,
                                u64 access);
    int                (*bitmap_spp_set_entry)(struct p2m_domain *p2m,
                                unsigned long gfn,
                                u64 access);
    int                (*bitmap_spp_range_set_entry)(struct p2m_domain *p2m,
                                unsigned long gfn,
                                u64 access, int size);
