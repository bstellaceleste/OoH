...
#define irq_caps_offset 560 /* offsetof(struct domain, irq_caps) */
#define next_in_list_offset 248 /* offsetof(struct domain, next_in_list) */
...
#define DOMAIN_is_32bit_pv 2192 /* offsetof(struct domain, arch.is_32bit_pv) */
...
#define DOMAIN_vm_assist 600 /* offsetof(struct domain, vm_assist) */
