...
typedef enum BlockdevDriver {
    ...
    BLOCKDEV_DRIVER_VXHS = 34,
    BLOCKDEV_DRIVER__MAX = 35,
} BlockdevDriver;
...
extern const char *const BlockdevQcow2EncryptionFormat_lookup[];
...
extern const char *const BlockdevQcowEncryptionFormat_lookup[];
...
typedef enum QKeyCode {
    ...
    Q_KEY_CODE_YEN = 124,
    Q_KEY_CODE_KP_COMMA = 125,
    Q_KEY_CODE_KP_EQUALS = 126,
    Q_KEY_CODE_POWER = 127,
    Q_KEY_CODE_SLEEP = 128,
    Q_KEY_CODE_WAKE = 129,
    Q_KEY_CODE_AUDIONEXT = 130,
    Q_KEY_CODE_AUDIOPREV = 131,
    Q_KEY_CODE_AUDIOSTOP = 132,
    Q_KEY_CODE_AUDIOPLAY = 133,
    Q_KEY_CODE_AUDIOMUTE = 134,
    Q_KEY_CODE_VOLUMEUP = 135,
    Q_KEY_CODE_VOLUMEDOWN = 136,
    Q_KEY_CODE_MEDIASELECT = 137,
    Q_KEY_CODE_MAIL = 138,
    Q_KEY_CODE_CALCULATOR = 139,
    Q_KEY_CODE_COMPUTER = 140,
    Q_KEY_CODE_AC_HOME = 141,
    Q_KEY_CODE_AC_BACK = 142,
    Q_KEY_CODE_AC_FORWARD = 143,
    Q_KEY_CODE_AC_REFRESH = 144,
    Q_KEY_CODE_AC_BOOKMARKS = 145,
    Q_KEY_CODE__MAX = 146,
} QKeyCode;
...
extern const char *const SocketAddressLegacyKind_lookup[];
...
extern const char *const SocketAddressType_lookup[];
