...
uint16_t _TRACE_QEMU_MUTEX_UNLOCKED_DSTATE;
...
TraceEvent _TRACE_QEMU_MUTEX_UNLOCKED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "qemu_mutex_unlocked",
    .sstate = TRACE_QEMU_MUTEX_UNLOCKED_ENABLED,
    .dstate = &_TRACE_QEMU_MUTEX_UNLOCKED_DSTATE 
};
TraceEvent *util_trace_events[] = {
    ...
    &_TRACE_QEMU_MUTEX_UNLOCKED_EVENT,
  NULL,
};
