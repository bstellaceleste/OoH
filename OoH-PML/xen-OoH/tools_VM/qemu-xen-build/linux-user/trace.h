...
static inline void _nocheck__trace_user_setup_frame(void * env, uint64_t frame_addr)
{
    if (trace_event_get_state(TRACE_USER_SETUP_FRAME)) {
        ...
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_setup_frame " "env=%p frame_addr=0x%"PRIx64 "\n",
                      getpid(),
...
static inline void _nocheck__trace_user_setup_rt_frame(void * env, uint64_t frame_addr)
{
    if (trace_event_get_state(TRACE_USER_SETUP_RT_FRAME)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_setup_rt_frame " "env=%p frame_addr=0x%"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , env, frame_addr);
    }
...
static inline void _nocheck__trace_user_do_rt_sigreturn(void * env, uint64_t frame_addr)
{
    if (trace_event_get_state(TRACE_USER_DO_RT_SIGRETURN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_do_rt_sigreturn " "env=%p frame_addr=0x%"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , env, frame_addr);
    }
...
static inline void _nocheck__trace_user_do_sigreturn(void * env, uint64_t frame_addr)
{
    if (trace_event_get_state(TRACE_USER_DO_SIGRETURN)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_do_sigreturn " "env=%p frame_addr=0x%"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , env, frame_addr);
    }
...
static inline void _nocheck__trace_user_force_sig(void * env, int target_sig, int host_sig)
{
    if (trace_event_get_state(TRACE_USER_FORCE_SIG)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_force_sig " "env=%p signal %d (host %d)" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_user_handle_signal(void * env, int target_sig)
{
    if (trace_event_get_state(TRACE_USER_HANDLE_SIGNAL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_handle_signal " "env=%p signal %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , env, target_sig);
    }
...
static inline void _nocheck__trace_user_host_signal(void * env, int host_sig, int target_sig)
{
    if (trace_event_get_state(TRACE_USER_HOST_SIGNAL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_host_signal " "env=%p signal %d (target %d(" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_user_queue_signal(void * env, int target_sig)
{
    if (trace_event_get_state(TRACE_USER_QUEUE_SIGNAL)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_queue_signal " "env=%p signal %d" "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
                      , env, target_sig);
    }
...
static inline void _nocheck__trace_user_s390x_restore_sigregs(void * env, uint64_t sc_psw_addr, uint64_t env_psw_addr)
{
    if (trace_event_get_state(TRACE_USER_S390X_RESTORE_SIGREGS)) {
        ...
        gettimeofday(&_now, NULL);
        qemu_log_mask(LOG_TRACE,
                      "%d@%zd.%06zd:user_s390x_restore_sigregs " "env=%p frame psw.addr 0x%"PRIx64 " current psw.addr 0x%"PRIx64 "\n",
                      getpid(),
                      (size_t)_now.tv_sec, (size_t)_now.tv_usec
