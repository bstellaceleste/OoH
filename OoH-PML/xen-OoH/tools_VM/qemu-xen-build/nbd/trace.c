...
uint16_t _TRACE_NBD_RECEIVE_STARTTLS_REQUEST_DSTATE;
uint16_t _TRACE_NBD_RECEIVE_STARTTLS_REPLY_DSTATE;
...
uint16_t _TRACE_NBD_RECEIVE_REPLY_DSTATE;
...
TraceEvent _TRACE_NBD_RECEIVE_STARTTLS_REQUEST_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_receive_starttls_request",
    .sstate = TRACE_NBD_RECEIVE_STARTTLS_REQUEST_ENABLED,
    .dstate = &_TRACE_NBD_RECEIVE_STARTTLS_REQUEST_DSTATE 
};
TraceEvent _TRACE_NBD_RECEIVE_STARTTLS_REPLY_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_receive_starttls_reply",
    .sstate = TRACE_NBD_RECEIVE_STARTTLS_REPLY_ENABLED,
    .dstate = &_TRACE_NBD_RECEIVE_STARTTLS_REPLY_DSTATE 
};
...
TraceEvent _TRACE_NBD_RECEIVE_REPLY_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_receive_reply",
    .sstate = TRACE_NBD_RECEIVE_REPLY_ENABLED,
    .dstate = &_TRACE_NBD_RECEIVE_REPLY_DSTATE 
};
...
TraceEvent _TRACE_NBD_SEND_REPLY_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_send_reply",
    .sstate = TRACE_NBD_SEND_REPLY_ENABLED,
    .dstate = &_TRACE_NBD_SEND_REPLY_DSTATE 
};
...
TraceEvent _TRACE_NBD_CO_SEND_REPLY_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "nbd_co_send_reply",
    .sstate = TRACE_NBD_CO_SEND_REPLY_ENABLED,
    .dstate = &_TRACE_NBD_CO_SEND_REPLY_DSTATE 
};
...
TraceEvent *nbd_trace_events[] = {
    ...
    &_TRACE_NBD_RECEIVE_STARTTLS_REQUEST_EVENT,
    &_TRACE_NBD_RECEIVE_STARTTLS_REPLY_EVENT,
    ...
    &_TRACE_NBD_RECEIVE_REPLY_EVENT,
