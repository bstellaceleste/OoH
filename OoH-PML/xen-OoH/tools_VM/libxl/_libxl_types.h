...
typedef enum libxl_domain_unpriv {
    LIBXL_DOMAIN_UNPRIV_DOM0 = 0,
    LIBXL_DOMAIN_UNPRIV_DOMU = 1,
} libxl_domain_unpriv;
...
const char *libxl_domain_unpriv_to_string(libxl_domain_unpriv p);
int libxl_domain_unpriv_from_string(const char *s, libxl_domain_unpriv *e);
extern libxl_enum_string_table libxl_domain_unpriv_string_table[];
...
typedef struct libxl_physinfo {
    libxl_domain_unpriv domain_unpriv;
