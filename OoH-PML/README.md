...
OoH is implemented using Xen 4.10.0 hypervisor, Linux 4.15.0 guest OS, BOCHS 2.6.11 Intel x86 emulator (only for EPML, which extends the hardware), Boehm Garbage Collector and CRIU.
